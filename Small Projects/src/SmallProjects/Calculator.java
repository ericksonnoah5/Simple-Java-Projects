...
public class Calculator implements ActionListener {
    ...
    public Calculator() {
        ...
        JButton[] allButtons = {
                clear, delete, fun, div,
                but7, but8, but9, mul,
                but4, but5, but6, sub,
                but1, but2, but3, add,
                empty, but0, dec, enter
        };
    ...
    public void actionPerformed(ActionEvent e) {
        if (!textf.getText().equals("Infinity")) {
            ...
            if (e.getSource() == enter) {
                if (count == endcount || textf.getText().substring(count).equals("/") ||
                        textf.getText().substring(count).equals("+") ||
                        textf.getText().substring(count).equals("-") ||
                        textf.getText().substring(count).equals("*") ||
                        textf.getText().substring(count - 1).equals(".")) {
                } else {
